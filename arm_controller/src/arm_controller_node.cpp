...
void PrintJointStates(const sensor_msgs::JointState::ConstPtr& joint_states) //funzione di callback
{
...
int main(int argc, char** argv)
{
    ...
    while (ros::ok()) {
        ...
        ros::spinOnce(); //consente di elaborare i messaggi in arrivo sul subscriber mentre il publisher continua a pubblicare mesaggi consentendo un corretto funzionamento del nodo sia come subscriber che come publisher.
        loop_rate.sleep();
